...
\begin{FunctionTable}
\Record{The review assignments issued on handin deadline as defined in \ref{sec:SysGenEvents} shall follow the rules defined in the notes in paragraph \ref{reqnote:reviewAssignments}.}{}{}
\end{FunctionTable}
