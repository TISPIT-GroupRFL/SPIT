...
\Dyn{1}{The integration must support subtask 1 of task \ref{sec:ManageStudents} in an efficient manner.}{}{}
\end{DynTable}

\begin{DynTable}{Data import}
\Dyn{1}{Imported data matches the record described in \ref{sec:DataStudent}}{}{}
\end{DynTable}

\begin{DynTable}{Data recency}
\Dyn{1}{Data must be imported when task \ref{sec:ManageStudents} is invoked.}{}{}
\end{DynTable}
...
\begin{DynTable}{Task support}
\Dyn{1}{All tasks require the user to be authenticated using the LDAP service. The authentication must take place if the user has been logged out, but when logged in, the user may perform all appropriate tasks.}{}{}
\end{DynTable}

\begin{DynTable}{Data recency}
\Dyn{1}{Data must be imported before invoking the first task of a session.}{}{}
\end{DynTable}
