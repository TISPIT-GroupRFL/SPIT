...
\Record{Override group status, such as marking handins as accepted, while noting the reason.}{}{}
\end{TaskTable}

\subsection{Handle end of lecturing}\label{sec:EOLecturing}

\begin{DataIntro}
\tStart{\code{When} the deadline for reviews of the last exercise of the semester has been passed.}
\tEnd{\code{When} the reports has been extracted. }
