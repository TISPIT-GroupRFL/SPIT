...
\begin{TaskTable}
\Record{Assess personal handin and review submission status along with feedback.}{The system provides an overview, showing all exercises, and status (handin and review submissions and feedback) for each exercise. The system may also show reviewees for each exercise.}{}
